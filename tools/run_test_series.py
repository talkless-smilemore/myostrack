...
TEST_JOBS = [
    {
        "config": "vitb_256_mae_ce_32x4_ep300_uav410_wsp",
        "dataset": "anti_uav410",
        "display_name": "OSTrack-uav-wsp",
    },
    # {
    #     "config": "vitb_256_mae_ce_32x4_ep300_uav_lora.yaml",
    #     "dataset": "anti_uav",
    #     "display_name": "OSTrack-uav-lora",
    # },
]
...
def parse_args():
    ...
    parser.add_argument("--threads", type=int, default=0, help="Number of test threads.")
