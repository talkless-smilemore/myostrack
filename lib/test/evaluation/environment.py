...
class EnvSettings:
    def __init__(self):
        ...
        self.uav_path = ''
        self.anti_uav_path = ''
        self.anti_uav410_path = ''
        self.anti_uav300_path = ''
        self.tpl_path = ''
        self.vot_path = ''
        self.got10k_path = ''
        self.lasot_path = ''
...
class EnvSettings_ITP:
    def __init__(self, workspace_dir, data_dir, save_dir):
        ...
        self.anti_uav_path = os.path.join(data_dir, 'anti_uav')
        self.anti_uav410_path = os.path.join(data_dir, 'anti_uav410')
        self.anti_uav300_path = os.path.join(data_dir, 'anti_uav300')
